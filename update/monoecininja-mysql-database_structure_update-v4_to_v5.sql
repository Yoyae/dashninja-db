...
--
-- Table structure for table `cmd_budget_monoeciwhale_comments`
--

CREATE TABLE `cmd_budget_monoeciwhale_comments` (
...
--
-- Indexes for table `cmd_budget_monoeciwhale_comments`
--

ALTER TABLE `cmd_budget_monoeciwhale_comments`
